...
export default function RAGBox({
  ...
  const handleSuggestionSelect = useCallback((hit: unknown) => {
    ...
    if (hit && typeof hit === "object") {
      ...
      // Try to use fields from the RAGBox configuration
  ...
  return (
    <div className="react-af-ragbox" ref={containerRef}>
      <form onSubmit={handleSubmit}>
        ...
        {value && (
          <button
            type="button"
            className="react-af-ragbox-clear"
            onClick={handleClear}
        ...
        <button type="submit" className="react-af-ragbox-submit" disabled={!value.trim()}>
          {buttonLabel}
        </button>
      </form>
      {children &&
