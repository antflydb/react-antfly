...
export default function RAGResults({ id, answerBoxId, summarizer, systemPrompt, renderSummary, showCitations, withCitations, showHits, fields, }: RAGResultsProps): import("react/jsx-runtime").JSX.Element;
